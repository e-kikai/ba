class ClientColumn < ActiveRecord::Base
  ...
  def add_client_column
    ...
    ActiveRecord::Base.connection.add_column(client_table.table_name, column_name, db_type)
  ...
  def change_client_column
    ...
    # ActiveRecord::Base.connection.change_column(client_table.table_name, column_name, "#{type.db_type} USING CAST(#{column_name} AS #{db_type})")
