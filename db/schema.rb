...
ActiveRecord::Schema.define(version: 20161017141255) do
  ...
  create_table "c31_20160324171635_575", force: :cascade do |t|
    ...
    t.integer  "company_id"
    t.string   "co_20160411153558_70"
    t.integer  "co_20160722165303_20"
    t.string   "co_20160824113543_852"
  end
  ...
  add_index "c31_20160324171635_575", ["co_20160722165303_20"], name: "index_c31_20160324171635_575_on_co_20160722165303_20", using: :btree
  add_index "c31_20160324171635_575", ["co_20160824113543_852"], name: "index_c31_20160324171635_575_on_co_20160824113543_852", using: :btree
  ...
  create_table "c31_20160819163228", force: :cascade do |t|
    t.datetime "created_at",        null: false
    t.datetime "updated_at",        null: false
    t.datetime "soft_destroyed_at"
    t.string   "name"
  ...
  add_index "c31_20160819163228", ["company_id"], name: "index_c31_20160819163228_on_company_id", using: :btree
  add_index "c31_20160819163228", ["name"], name: "index_c31_20160819163228_on_name", using: :btree
  add_index "c31_20160819163228", ["soft_destroyed_at"], name: "index_c31_20160819163228_on_soft_destroyed_at", using: :btree
  ...
  create_table "c31_companies", force: :cascade do |t|
    ...
    t.string   "target"
    t.string   "influx"
    t.integer  "co_20160823103307_978"
  end

  add_index "c31_companies", ["address"], name: "index_c31_companies_on_address", using: :btree
  add_index "c31_companies", ["co_20160823103307_978"], name: "index_c31_companies_on_co_20160823103307_978", using: :btree
  ...
  create_table "c33_20160722141122", force: :cascade do |t|
    t.datetime "created_at",        null: false
    t.datetime "updated_at",        null: false
    t.datetime "soft_destroyed_at"
    t.string   "name"
  ...
  add_index "c33_20160722141122", ["company_id"], name: "index_c33_20160722141122_on_company_id", using: :btree
  add_index "c33_20160722141122", ["name"], name: "index_c33_20160722141122_on_name", using: :btree

  create_table "c33_20160722141221", force: :cascade do |t|
    t.datetime "created_at",        null: false
    t.datetime "updated_at",        null: false
    t.datetime "soft_destroyed_at"
    t.string   "name"
  ...
  add_index "c33_20160722141221", ["company_id"], name: "index_c33_20160722141221_on_company_id", using: :btree
  add_index "c33_20160722141221", ["name"], name: "index_c33_20160722141221_on_name", using: :btree
  ...
  create_table "c36_companies", force: :cascade do |t|
    t.datetime "created_at",        null: false
    t.datetime "updated_at",        null: false
    t.datetime "soft_destroyed_at"
    t.string   "name"
  ...
  add_index "c36_companies", ["address"], name: "index_c36_companies_on_address", using: :btree
  add_index "c36_companies", ["fax"], name: "index_c36_companies_on_fax", using: :btree
  add_index "c36_companies", ["influx"], name: "index_c36_companies_on_influx", using: :btree
  add_index "c36_companies", ["mail"], name: "index_c36_companies_on_mail", using: :btree
  add_index "c36_companies", ["name"], name: "index_c36_companies_on_name", using: :btree
  add_index "c36_companies", ["pref"], name: "index_c36_companies_on_pref", using: :btree
  add_index "c36_companies", ["status"], name: "index_c36_companies_on_status", using: :btree
  add_index "c36_companies", ["target"], name: "index_c36_companies_on_target", using: :btree
  add_index "c36_companies", ["tel"], name: "index_c36_companies_on_tel", using: :btree
  add_index "c36_companies", ["url"], name: "index_c36_companies_on_url", using: :btree
  add_index "c36_companies", ["zip"], name: "index_c36_companies_on_zip", using: :btree
  ...
  add_index "infos", ["client_id"], name: "index_infos_on_client_id", using: :btree
  add_index "infos", ["soft_destroyed_at"], name: "index_infos_on_soft_destroyed_at", using: :btree
